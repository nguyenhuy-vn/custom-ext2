...
#include "xattr.h"
#include "acl.h"
//#define XATTR_USER_CREATION_TIME "user.creation_time"
//#define TIMEZONE_OFFSET (7*3600) //UTC +7
...
{	
	// Check if 'creation_time' is being set for the first time
...
bad_block:
	...
	printk(KERN_INFO "ext2_xattr_set: Thiết lập xattr thành công\n");
